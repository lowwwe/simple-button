...
void Game::processEvents()
{
	...
	while (m_window.pollEvent(newEvent))
	{
		...
		{
			processMouseClick(newEvent);// process mouse
		}
	}
}
...
void Game::processMouseClick(sf::Event t_event)
{
	...
	{
		bounds = m_buttonSprite.getGlobalBounds();
		if (bounds.contains(mouse))
		{
			m_buttonRed = !m_buttonRed;
			if (m_buttonRed)
			{
				m_buttonSprite.setTextureRect(sf::IntRect{ 203,0,203,197 });
			}
			else
			{
